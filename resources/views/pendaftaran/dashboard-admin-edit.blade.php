                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <option value="1" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah ?? '') == '1' ? 'selected' : '' }}> Kurang dari Rp.500.000</option>
                                <option value="2" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah ?? '') == '2' ? 'selected' : '' }}>Kurang dari Rp.1.000.000</option>
                                <option value="3" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah ?? '') == '3' ? 'selected' : '' }}>Kurang dari Rp.2.000.000</option>
                                <option value="4" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah ?? '') == '4' ? 'selected' : '' }}> Rp.2.000.000</option>
                                <option value="5" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah ?? '') == '5' ? 'selected' : '' }}>Lebih dari Rp.2.000.000</option>
                                <option value="6" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah ?? '') == '6' ? 'selected' : '' }}>Lebih dari Rp.4.000.000</option>
                              </select>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <option value="1" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu ?? '') == '1' ? 'selected' : '' }}> Kurang dari Rp.500.000</option>
                                <option value="2" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu ?? '') == '2' ? 'selected' : '' }}>Kurang dari Rp.1.000.000</option>
                                <option value="3" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu ?? '') == '3' ? 'selected' : '' }}>Kurang dari Rp.2.000.000</option>
                                <option value="4" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu ?? '') == '4' ? 'selected' : '' }}> Rp.2.000.000</option>
                                <option value="5" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu ?? '') == '5' ? 'selected' : '' }}>Lebih dari Rp.2.000.000</option>
                                <option value="6" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu ?? '') == '6' ? 'selected' : '' }}>Lebih dari Rp.4.000.000</option>
                              </select>
                            </div>
                          </div>
                        </div>
